...
#ifndef DDECAL_GAIN_SOLVERS_ITERATIVE_SCALAR_SOLVER_CUDA_H_
#define DDECAL_GAIN_SOLVERS_ITERATIVE_SCALAR_SOLVER_CUDA_H_
...
#endif  // DDECAL_GAIN_SOLVERS_ITERATIVE_SCALAR_SOLVER_CUDA_H_
